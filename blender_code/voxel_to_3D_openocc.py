...
# 读取 .npy 文件
file_path = '/Users/wangzhicheng/Desktop/FSD/Blender_3D/prediction/openocc/1ac565faae6141788049c96c63e5ee58.npy'
voxel_data = np.load(file_path)  # (N, 4), N: number of occupied voxels, 4: z, y, x, semantic_label

# 体素参数
voxel_size = (0.2, 0.2, 0.2)  # 每个体素的实际大小 (x, y, z)
...
for voxel in voxel_data:
    z, y, x, semantic_label = voxel  # 解析体素数据
    if 0 <  semantic_label < len(materials):  # 检查语义标签是否有效
        voxel_center = Vector((
        ...
        # 为每个面分配材质
        face_materials.extend([semantic_label] * 6)
